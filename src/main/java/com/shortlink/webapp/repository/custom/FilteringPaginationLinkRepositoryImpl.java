...
public class FilteringPaginationLinkRepositoryImpl implements FilteringPaginationLinkRepository {
    private final EntityManager entityManager;
    private final MessageSource messageSource;

    @Override
    public Page<AllLinksReadDto> findPageOfLinks(Predicate predicate, Pageable pageable) {
        return getAllLinksReadDto(
                extractOrderSpecifiers(pageable),
                countTotalResult(predicate, link.linkStatistics),
                predicate,
                pageable,
                link.linkStatistics);
    }
    ...
    public Page<AllLinksReadDto> findPageOfLinksForUser(Predicate predicate, Pageable pageable) {
        return getAllLinksReadDto(
                extractOrderSpecifiers(pageable),
                countTotalResult(predicate, link.user, link.linkStatistics),
                predicate,
                pageable,
